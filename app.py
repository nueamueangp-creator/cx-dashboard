...
# =========================================================================
# 5. โซนกราฟแถวล่างสุด: วิเคราะห์ความเสถียร (ล็อกสีตามกลุ่มผลงานปัจจุบันและเพิ่มตัวเลขบนแท่ง)
# =========================================================================
...
fig_custom_box.add_trace(go.Bar(
    ...
    marker_color=df_box_stat["color_group"].tolist(), # 🎨 พ่นสีตามกลุ่มผลงานปัจจุบัน (ตรงกับกราฟบน)
    text=df_box_stat["Mean"].round(2),                # 🎯 แสดงตัวเลขคะแนนเฉลี่ยบนแท่งกราฟ
    textposition="inside",                             # 📍 จัดให้อยู่ด้านในปลายแท่งเพื่อหลบหนวดกราฟ
    textfont=dict(color="white", weight="bold"),       # 🎨 ปรับฟอนต์สีขาวหนาให้อ่านง่าย
...
if "วันที่ประเมิน" in df_filtered.columns and not df_filtered.empty:
    ...
    df_pivot_prep["壓ันที่ประเมิน" if "壓ันที่ประเมิน" in df_pivot_prep.columns else "วันที่ประเมิน"] = df_pivot_prep["壓ันที่ประเมิน" if "壓ันที่ประเมิน" in df_pivot_prep.columns else "วันที่ประเมิน"]
